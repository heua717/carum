...
function UnityCarum() {
  const { isLoaded, unityProvider, sendMessage, addEventListener, removeEventListener,requestFullscreen  } = useUnityContext({
  ...
  }, [addEventListener, removeEventListener, handleReactRouting,reactCall, isLoaded]);
