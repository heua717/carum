      ...
      <div className={styles.emotionCheckBox}>
        ...
        <div className={styles.emotions}>
          <img
            ...
            className={`${styles.emotionImg} ${isChecked('angry') ? styles.checked : null}`}
            src={angryImg}
            alt='emotion'
          />
          <img
            onClick={() => clickEmotion("sad")}
            className={`${styles.emotionImg} ${isChecked('sad') ? styles.checked : null}`}
            src={sadImg}
            alt='emotion'
          />
          <img
            onClick={() => clickEmotion("happy")}
            className={`${styles.emotionImg} ${isChecked('happy') ? styles.checked : null}`}
            src={happyImg}
            alt='emotion'
          />
          <img
            onClick={() => clickEmotion("worry")}
            className={`${styles.emotionImg} ${isChecked('worry') ? styles.checked : null}`}
            src={worryImg}
            alt='emotion'
          />
          <img
            onClick={() => clickEmotion("peace")}
            className={`${styles.emotionImg} ${isChecked('peace') ? styles.checked : null}`}
            src={peaceImg}
            alt='emotion'
          />
          <img
            onClick={() => clickEmotion("surprise")}
            className={`${styles.emotionImg} ${isChecked('surprise') ? styles.checked : null}`}
            src={surpriseImg}
            alt='emotion'
          />
        </div>
        <div className={`${styles.emotionExplainBox} 
          ${values.selectedEmotion === 'angry' ? styles.angryBg : 
          values.selectedEmotion === 'sad' ? styles.sadBg : 
          values.selectedEmotion === 'happy' ? styles.happyBg : 
          values.selectedEmotion === 'worry' ? styles.worryBg : 
          values.selectedEmotion === 'peace' ? styles.peaceBg : 
          styles.surpriseBg}`
        }>
